#ifndef SimTotem_RPDigiProducer_RP_PILE_UP_SIGNALS_H
#define SimTotem_RPDigiProducer_RP_PILE_UP_SIGNALS_H
...
#endif  //SimTotem_RPDigiProducer_RP_PILE_UP_SIGNALS_H
