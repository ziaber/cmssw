#ifndef SimTotem_RPDigiProducer_RP_LINEAR_CHARGE_DIVIDER_H
#define SimTotem_RPDigiProducer_RP_LINEAR_CHARGE_DIVIDER_H
...
#endif  //SimTotem_RPDigiProducer_RP_LINEAR_CHARGE_DIVIDER_H
