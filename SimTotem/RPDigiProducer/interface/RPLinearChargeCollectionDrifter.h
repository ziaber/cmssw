#ifndef SimTotem_RPDigiProducer_RP_LINEAR_CHARGE_COLLECTION_DRIFTER_H
#define SimTotem_RPDigiProducer_RP_LINEAR_CHARGE_COLLECTION_DRIFTER_H
...
#endif  //SimTotem_RPDigiProducer_RP_LINEAR_CHARGE_COLLECTION_DRIFTER_H
