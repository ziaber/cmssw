#include "RecoCTPPS/RPInelasticReconstruction/interface/RPPrimaryVertex2ArmReconstruction.h"
...
void RPPrimaryVertex2ArmReconstruction::InitInverseParametrizationFitter()
{
  ...
  if(verbosity_)
    std::cout<<"RPPrimaryVertex2ArmReconstruction::InitInverseParametrizationFitter"<<std::endl;
