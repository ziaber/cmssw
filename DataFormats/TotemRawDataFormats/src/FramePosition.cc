...
const string FramePosition::tagSSNone ="None"; 
const string FramePosition::tagSST1 ="T1";   
const string FramePosition::tagSST2 ="T2";  
const string FramePosition::tagSSRP ="RP"; 
const string FramePosition::tagSSTrigger ="Trigger"; 
const string FramePosition::tagSSTTC ="TTC"; 
const string FramePosition::tagSSFEC ="FEC"; 

//----------------------------------------------------------------------------------------------------

std::ostream& operator << (std::ostream& s, const FramePosition &fp)
{
  return s << std::hex
    << fp.GetSubSystemId() << ":"
...
unsigned char FramePosition::SetXMLAttribute(const std::string &attribute, const std::string &value,
    unsigned char &flag)
{
  ...
  if (attribute.compare("position") == 0) {
    rawPosition = v;
    flag |= 0x20;
    WARN("DAQInformationSourceXML::ChipFramePosition") << "DAQ channel (" << (*this) << 
      ") has been initialized from a deprecated `position' tag. Update your XML file!";
    return 0;
  }
