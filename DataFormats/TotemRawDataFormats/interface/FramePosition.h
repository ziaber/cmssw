...
#ifndef _Totem_FramePosition_h_
#define _Totem_FramePosition_h_
...
class FramePosition
{
  public:
    ...
    FramePosition(unsigned short SubSystemId, unsigned short TOTFEDId, unsigned short OptoRxId, unsigned short GOHId, unsigned short IdxInFiber) :
    ...
    FramePosition(unsigned int pos = 0) : rawPosition(pos) {}
  ...
  protected:
    ...
    friend class OptoRxVFATFrameCollection;
